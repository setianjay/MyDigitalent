...
class SqliteHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE $TABLE_USER($KEY_USER_ID INTEGER PRIMARY KEY AUTOINCREMENT, $KEY_USER_USERNAME TEXT, $KEY_USER_ADDRESS TEXT, $KEY_USER_PHONE TEXT, $KEY_USER_GENDER TEXT, $KEY_USER_PASSWORD TEXT, $KEY_USER_PHOTO BLOB, $KEY_USER_LATITUDE TEXT, $KEY_USER_LONGITUDE TEXT)")
    }
    ...
    fun addUser(userArg: UserArg): Long{
        ...
        val photo = ViewUtil.getByteArrayFromBitmap(userArg.photo)
        val result: Long
    ...
    fun getUserByUsername(username: String): User? {
        ...
        if(cursor.moveToFirst()) {
            val photoByte = cursor.getBlob(6)
            return User(
                cursor.getInt(0),
                cursor.getString(1),
                cursor.getString(2),
                ...
                cursor.getString(5),
                ViewUtil.getBitmapFromByteArray(photoByte),
